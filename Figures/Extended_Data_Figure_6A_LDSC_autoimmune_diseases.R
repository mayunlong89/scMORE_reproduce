...
# 读取数据
df <- read_excel("/share/pub/guiyy/Cerebral_comorbidities/LDSC/result/plot/ldsc_autoimmune.xlsx")
...
pdf("/share/pub/guiyy/Cerebral_comorbidities/LDSC/result/plot/LDSC_autoimmune.pdf",width=10,height=10)
