...
XXX_spredixcan <- read.csv("./TWAS/baso_count/SMultiXcan_results/spredixcan/eqtl/mashr/baso_count_GWAS_mashr_Thyroid.db.csv",header = T)
gene_info <- XXX_spredixcan[,c("gene_name","zscore","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")

geneRiskScores_9K <- getGeneScore(gene_info)
#head(geneRiskScores_9K)
...
####------lymph_count_spredixcan

setwd("/Users/mayunlong/Desktop/WMU2024/ctDRTF-codes and data/scHBO/2024-11-20-ctDRTF_re-analysis/02-10-blood_traits/Method_envalue/")

XXX_spredixcan <- read.csv("./TWAS/lymphocyte_count/SMultiXcan_results/spredixcan/eqtl/mashr/lymphocyte_count_GWAS_mashr_Whole_Blood.db.csv",header = T)
gene_info <- XXX_spredixcan[,c("gene_name","zscore","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
...
####------lymph_percent_spredixcan

setwd("/Users/mayunlong/Desktop/WMU2024/ctDRTF-codes and data/scHBO/2024-11-20-ctDRTF_re-analysis/02-10-blood_traits/Method_envalue/")


XXX_spredixcan <- read.csv("./TWAS/lymphocyte_percent/SMultiXcan_results/spredixcan/eqtl/mashr/lymphocyte_percent_GWAS_mashr_Whole_Blood.db.csv",header = T)
gene_info <- XXX_spredixcan[,c("gene_name","zscore","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
...
XXX_spredixcan <- read.csv("./TWAS/eosin_count/SMultiXcan_results/spredixcan/eqtl/mashr/eosin_count_GWAS_mashr_Whole_Blood.db.csv",header = T)
gene_info <- XXX_spredixcan[,c("gene_name","zscore","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
...
XXX_spredixcan <- read.csv("./TWAS/HL_count/SMultiXcan_results/spredixcan/eqtl/mashr/HL_count_GWAS_mashr_Whole_Blood.db.csv",header = T)
gene_info <- XXX_spredixcan[,c("gene_name","zscore","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
...
XXX_spredixcan <- read.csv("./TWAS/MCHC_count/SMultiXcan_results/spredixcan/eqtl/mashr/MCHC_count_GWAS_mashr_Whole_Blood.db.csv",header = T)
gene_info <- XXX_spredixcan[,c("gene_name","zscore","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
...
XXX_spredixcan <- read.csv("./TWAS/wbc_count/SMultiXcan_results/spredixcan/eqtl/mashr/wbc_count_GWAS_mashr_Whole_Blood.db.csv",header = T)
gene_info <- XXX_spredixcan[,c("gene_name","zscore","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
...
XXX_spredixcan <- read.csv("./TWAS/neutr_count/SMultiXcan_results/spredixcan/eqtl/mashr/neutr_count_GWAS_mashr_Whole_Blood.db.csv",header = T)
gene_info <- XXX_spredixcan[,c("gene_name","zscore","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
...
XXX_spredixcan <- read.csv("./TWAS/MCV_count/SMultiXcan_results/spredixcan/eqtl/mashr/MCV_count_GWAS_mashr_Whole_Blood.db.csv",header = T)
gene_info <- XXX_spredixcan[,c("gene_name","zscore","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
...
XXX_spredixcan <- read.csv("./TWAS/monocyte_count/SMultiXcan_results/spredixcan/eqtl/mashr/monocyte_count_GWAS_mashr_Whole_Blood.db.csv",header = T)
gene_info <- XXX_spredixcan[,c("gene_name","zscore","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
...
XXX_spredixcan <- read.csv("./TWAS/monocyte_count/SMultiXcan_results/spredixcan/eqtl/mashr/monocyte_count_GWAS_mashr_Adipose_Subcutaneous.db.csv",header = T)
gene_info <- XXX_spredixcan[,c("gene_name","zscore","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
