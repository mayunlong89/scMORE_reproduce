...
XXX_Smultixcan <- read.table("./TWAS/baso_count/SMultiXcan_results/smultixcan/eqtl/baso_count_GWAS_mashr_smultixcan_eqtl.txt",header = T)
gene_info <- XXX_Smultixcan[,c("gene_name","z_mean","pvalue")]
#head(gene_info)
...
####------lymph_count_Smultixcan

setwd("/Users/mayunlong/Desktop/WMU2024/ctDRTF-codes and data/scHBO/2024-11-20-ctDRTF_re-analysis/02-10-blood_traits/Method_envalue/")

XXX_Smultixcan <- read.table("./TWAS/lymphocyte_count/SMultiXcan_results/smultixcan/eqtl/lymphocyte_count_GWAS_mashr_smultixcan_eqtl.txt",header = T)
gene_info <- XXX_Smultixcan[,c("gene_name","z_mean","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
...
####------lymph_percent_Smultixcan

setwd("/Users/mayunlong/Desktop/WMU2024/ctDRTF-codes and data/scHBO/2024-11-20-ctDRTF_re-analysis/02-10-blood_traits/Method_envalue/")

XXX_Smultixcan <- read.table("./TWAS/lymphocyte_percent/SMultiXcan_results/smultixcan/eqtl/lymphocyte_percent_GWAS_mashr_smultixcan_eqtl.txt",header = T)
gene_info <- XXX_Smultixcan[,c("gene_name","z_mean","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
...
XXX_Smultixcan <- read.table("./TWAS/eosin_count/SMultiXcan_results/smultixcan/eqtl/eosin_count_GWAS_mashr_smultixcan_eqtl.txt",header = T)
gene_info <- XXX_Smultixcan[,c("gene_name","z_mean","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
...
XXX_Smultixcan <- read.table("./TWAS/HL_count/SMultiXcan_results/smultixcan/eqtl/HL_count_GWAS_mashr_smultixcan_eqtl.txt",header = T)
gene_info <- XXX_Smultixcan[,c("gene_name","z_mean","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
...
XXX_Smultixcan <- read.table("./TWAS/MCHC_count/SMultiXcan_results/smultixcan/eqtl/MCHC_count_GWAS_mashr_smultixcan_eqtl.txt",header = T)
gene_info <- XXX_Smultixcan[,c("gene_name","z_mean","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
...
XXX_Smultixcan <- read.table("./TWAS/wbc_count/SMultiXcan_results/smultixcan/eqtl/wbc_count_GWAS_mashr_smultixcan_eqtl.txt",header = T)
gene_info <- XXX_Smultixcan[,c("gene_name","z_mean","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
...
XXX_Smultixcan <- read.table("./TWAS/neutr_count/SMultiXcan_results/smultixcan/eqtl/neutr_count_GWAS_mashr_smultixcan_eqtl.txt",header = T)
gene_info <- XXX_Smultixcan[,c("gene_name","z_mean","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
...
XXX_Smultixcan <- read.table("./TWAS/MCV_count/SMultiXcan_results/smultixcan/eqtl/MCV_count_GWAS_mashr_smultixcan_eqtl.txt",header = T)
gene_info <- XXX_Smultixcan[,c("gene_name","z_mean","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
...
XXX_Smultixcan <- read.table("./TWAS/monocyte_count/SMultiXcan_results/smultixcan/eqtl/monocyte_count_GWAS_mashr_smultixcan_eqtl.txt",header = T)
gene_info <- XXX_Smultixcan[,c("gene_name","z_mean","pvalue")]
#head(gene_info)
colnames(gene_info)<- c("SYMBOL","ZSTAT","P")
