...
XXX_SMR <- read.table("./SMR/baso_count_maf0.01.txt.filtered.smr",header = T)

gene_info <- XXX_SMR[,c("Gene","b_SMR","p_SMR")]
#head(gene_info)
...
XXX_SMR <- read.table("./SMR/lymphocyte_count_maf0.01.txt.filtered.smr",header = T)
...
XXX_SMR <- read.table("./SMR/lymphocyte_percent_maf0.01.txt.filtered.smr",header = T)
...
XXX_SMR <- read.table("./SMR/eosin_count_maf0.01.txt.filtered.smr",header = T)
...
XXX_SMR <- read.table("./SMR/HL_count_maf0.01.txt.filtered.smr",header = T)
...
XXX_SMR <- read.table("./SMR/MCHC_count_maf0.01.txt.filtered.smr",header = T)
...
XXX_SMR <- read.table("./SMR/wbc_count_maf0.01.txt.filtered.smr",header = T)
...
XXX_SMR <- read.table("./SMR/neutr_count_maf0.01.txt.filtered.smr",header = T)
...
XXX_SMR <- read.table("./SMR/MCV_count_maf0.01.txt.filtered.smr",header = T)
...
XXX_SMR <- read.table("./SMR/monocyte_count_maf0.01.txt.filtered.smr",header = T)
